...
//  -----  import plugins  -  bxSlider y jquery.form-validator  -----
...
import { jQueryFormValidator } from "/04-master-javascript-clasico-jquery-typescript-mean/05-proyecto-html5-css3-javascript-jquery/src/plugins/jquery.form-validator-2.3.79/jquery.form-validator-module.min.js";
...
const scriptsUrls = [
    ...
    '/04-master-javascript-clasico-jquery-typescript-mean/05-proyecto-html5-css3-javascript-jquery/src/plugins/jquery.form-validator-2.3.79/lang/es.js',
    '/04-master-javascript-clasico-jquery-typescript-mean/05-proyecto-html5-css3-javascript-jquery/src/scripts/contacto.js',
    ...
    .then($ => {
        ...
        loadJQueryUIByCdnOLocal(cdnJQueryUI, localJQueryUI)
            ...
            .then($ => {
                ...
                //  -----  cargamos plugins bxSlider y jquery.form-validator convertido a module  -----
                bxSlider($);
                jQueryFormValidator($)
