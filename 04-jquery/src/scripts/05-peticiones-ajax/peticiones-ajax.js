...
(function ($) {
    ...
    console.log('\n')
    console.warn('-----  peticiones-ajax.js  -----');
    ...
    */
    ...
    const urlLoad = '/04-master-javascript-clasico-jquery-typescript-mean/04-jquery/05-peticiones-ajax/services/home-jquery.html';
